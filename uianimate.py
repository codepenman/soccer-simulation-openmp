...
class FootballGround(object):
     def __init__(self):
        ...
        # Calling this to initialize values of players
        Main.play()

        points = Main.getPlayerPositions()
        print(points)
        ...
        for point in points:
            player = self.canvas.create_oval(point.x, point.y, point.x + 30, point.y + 30, outline='blue', fill='blue')
        ...
        while True:
            ...
            if track == 0:
                ...
                for player in self.players:
                    self.canvas.move(player, x + random.randint(0,5), y + random.randint(0,3))
